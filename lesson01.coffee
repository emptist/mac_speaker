module.exports = {
  ...
  CQs: {
    ...
    student: [
      ...
      "I said 'I could not hear a word'. "
  ...
  AQT: {
    ...
    teacher:[
      ...
      "How...?"
      "Ask me if I could not hear the actors."
      "Who...?"
    ...
    student:[
      ...
      "Could not you hear the actors?"
      "Who could not you hear?"
      "Did you turn around?"
      "What did you do?"
  ...
  OC: {
    ...
    teacher: [
      ...
      "In the end - could not bear"
      "can not hear - word - said"
